...
(1, '2014-03-06 14:12:00', NULL, 1, 1, '<span style="font-size: 13px;">Lorem Ipsum</span><span style="font-size: 13px;">&nbsp;es simplemente el texto de relleno de las imprentas y archivos de texto...</span>', 'Lorem Ipsum', 'lorem-ipsum', 0, 'Lorem Ipsum&nbsp;es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno est&aacute;ndar de las industrias desde el a&ntilde;o 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido us&oacute; una galer&iacute;a de textos y los mezcl&oacute; de tal manera que logr&oacute; hacer un libro de textos especimen. No s&oacute;lo sobrevivi&oacute; 500 a&ntilde;os, sino que tambien ingres&oacute; como texto de relleno en documentos electr&oacute;nicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creaci&oacute;n de las hojas &quot;Letraset&quot;, las cuales contenian pasajes de Lorem Ipsum, y m&aacute;s recientemente con software de autoedici&oacute;n, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.', '', '', 1, 1394111520, 0, '3 months', 'live', 'wysiwyg-advanced', '');
...
--
-- Estructura de tabla para la tabla `default_gallery`
--

CREATE TABLE IF NOT EXISTS `default_gallery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `default_gallery`
--

INSERT INTO `default_gallery` (`id`, `type`, `title`, `content`) VALUES
(10, 1, 'Espatula Sobre Lienzo, Leonid Afremov4', 'uploads/default/gallery/73a58b5f5ad5193feecf3217567efb04.jpg'),
(11, 1, 'Paisajes urbanos pintados con espatula', 'uploads/default/gallery/e9209595b93ae35dc4b2fa17fd2d16a8.jpg'),
(12, 2, NULL, '&lt;iframe width="260" height="202" src="//www.youtube.com/embed/D9GwupBkUDY" frameborder="0" allowfullscreen&gt;&lt;/iframe>'),
(13, 2, NULL, '&lt;iframe width="420" height="315" src="//www.youtube.com/embed/-aL5xgPHm_Q" frameborder="0" allowfullscreen&gt;&lt;/iframe>'),
(14, 1, 'tremendo arte', 'uploads/default/gallery/035ac03322c779556afaba99697b695e.jpg'),
(15, 1, 'Lorem Ipsum', 'uploads/default/gallery/a4b719c92988387a1d1da21f8f59fb8f.jpg');
...
(1, '<span style="font-size:18px;"><em><strong>Lorem Ipsum</strong></em></span>&nbsp;es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno est&aacute;ndar de las industrias desde el');
...
(1, 'uploads/default/home_banner/84197e20ed75fcd87e45fd01684b2c85.png', 'Imaginamos', 'Estrategias Digitales apoyadas en desarrollos innovadores que atrapan a sus clientes.', 'http://imaginamos.com'),
(2, 'uploads/default/home_banner/5b1db031838bd6ac4d5c7a30050cdcf9.png', 'Facebook', 'Facebook te ayuda a comunicarte y compartir con las personas que forman parte de tu vida.', 'http://facebook.com'),
(4, 'uploads/default/home_banner/d95b00cd2c3dae35c30a6720655a81ab.png', 'Bitbucket', 'Git the whole picture in JIRA Keep team leads, project managers and product own', 'http://bitbucket.com'),
(5, 'uploads/default/home_banner/19af3d4d80d551d721ccf53284a73ea3.jpg', 'Banner Prueba', 'Texto de Banner Prueba', '');
...
INSERT INTO `default_home_customers` (`id`, `name`, `image`, `link`) VALUES
(11, 'prueba', 'uploads/default/home_customers/c7699acb6050c1392c1c1630a3325ba7.jpg', 'https://www.google.com.co'),
(12, 'prueba2', 'uploads/default/home_customers/32a2f1fe5375c4ea93311e1151e0100b.jpg', 'https://www.google.com.co'),
(13, 'Prueba', 'uploads/default/home_customers/3a9d2f6d92fd1cc21699a30524b2845a.jpg', 'http://imaginamos.com'),
(14, 'Marranita', 'uploads/default/home_customers/c34cd63978f0eda9dea69e5f9731dede.jpg', 'http://localhost/nucleo-base/'),
(15, 'lorem', 'uploads/default/home_customers/74343acec710c523c0be398ab7f5511c.jpg', 'http://localhost/nucleo-base/');
...
CREATE TABLE IF NOT EXISTS `default_home_outstanding` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(455) COLLATE utf8_unicode_ci DEFAULT NULL,
  `image` varchar(455) COLLATE utf8_unicode_ci DEFAULT NULL,
  `text` text COLLATE utf8_unicode_ci,
...
INSERT INTO `default_home_outstanding` (`id`, `title`, `image`, `text`, `type`, `link`) VALUES
(2, '¿Que es lorem ipsum?', 'uploads/default/home_outstanding/37cb4ae91d868097d2e7e556ce17cdc6.jpg', 'Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar', 2, 'http://google.com'),
(5, 'Lorem Ipsum is simply', 'uploads/default/home_outstanding/08b6aefc5518b63b1aa986df7fdd48af.jpg', 'Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno e', 1, 'http://imaginamos.com'),
(7, '¿De donde viene?', 'uploads/default/home_outstanding/6dc57263cafae9e96a3e5095877d69f9.jpeg', 'Al contrario del pensamiento popular, el texto de Lorem Ipsum no es simplemente texto aleatorio. Tiene sus raices en una pieza', 2, 'http://google.com'),
(8, '¿Donde encontrarlo?', 'uploads/default/home_outstanding/fce08e7602d4c979eee2a7d64c21eec2.jpg', 'Hay muchas variaciones de los pasajes de Lorem Ipsum disponibles, pero la mayoría sufrió alteraciones en alguna manera', 2, 'http://google.com'),
(9, 'Lorem ipsum', 'uploads/default/home_outstanding/94242c99e0fa28a72ebc082fa4c7c813.jpg', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas consequat facilisis tristique. Integer id vestibulum', 1, 'http://imaginamos.com'),
(10, 'Lorem Ipsum', 'uploads/default/home_outstanding/86fe3e453c54441ff05c474c0f3971e6.jpg', 'Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno', 1, 'https://www.google.com.co');
...
CREATE TABLE IF NOT EXISTS `default_home_text_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `default_home_text_info` (`id`, `title`, `text`, `date`) VALUES
(1, 'Texto Informativo', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse molestie lorem nulla, et porttitor lectus commodo et. Pellentesque id diam tortor. Duis sagittis nulla tincidunt nisi dictum, eget imperdiet arcu fermentum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras rhoncus rhoncus arcu. Curabitur feugiat sollicitudin purus. Suspendisse ac dapibus augue. Phasellus ut ligula e2', '12-03-2014');
...
(32, 'a:2:{s:2:"es";s:28:"Herramientas de Maquetación";s:2:"en";s:5:"Tools";}', 'tools', '1.0', NULL, 'a:2:{s:2:"es";s:48:"Herramientas de Maquetación © Adrian Rodriguez";s:2:"en";s:32:"Layout Tools © Adrian Rodriguez";}', 0, 0, 1, 'content', 1, 1, 0, 1408982159),
(57, 'a:2:{s:2:"en";s:12:"Upload Files";s:2:"es";s:15:"Cargar Archivos";}', 'multi_upload_files', '1.2', NULL, 'a:2:{s:2:"en";s:42:"Upload Files © Luis Fernando Salazar 2014";s:2:"es";s:38:"Archivos © Luis Fernando Salazar 2014";}', 0, 1, 1, 'content', 1, 1, 0, 1408982159),
(34, 'a:2:{s:2:"en";s:18:"News with comments";s:2:"es";s:24:"Noticias con comentarios";}', 'news', '1.1', NULL, 'a:2:{s:2:"en";s:54:"This is a module of news © Brayan Acebo, Luis Salazar";s:2:"es";s:48:"Modulo de Noticias © Brayan Acebo, Luis Salazar";}', 0, 1, 1, 'content', 1, 1, 0, 1408982159),
...
(53, 'a:2:{s:2:"en";s:8:"Products";s:2:"es";s:9:"Productos";}', 'products', '1.1', NULL, 'a:2:{s:2:"en";s:52:"Products © Brayan Acebo, luis fernando salazar 2014";s:2:"es";s:53:"Productos © Brayan Acebo, luis fernando salazar 2014";}', 0, 1, 1, 'content', 1, 1, 0, 1408982159),
(47, 'a:2:{s:2:"es";s:7:"Galeria";s:2:"en";s:7:"Gallery";}', 'gallery', '1.1', NULL, 'a:2:{s:2:"es";s:37:"Modulo Galeria Simple © Brayan Acebo";s:2:"en";s:37:"Module Simple Gallery © Brayan Acebo";}', 0, 1, 1, 'content', 1, 1, 0, 1408982159),
(60, 'a:2:{s:2:"en";s:8:"services";s:2:"es";s:9:"servicios";}', 'services', '1.2', NULL, 'a:2:{s:2:"en";s:52:"services © Brayan Acebo, luis fernando salazar 2014";s:2:"es";s:53:"servicios © Brayan Acebo, luis fernando salazar 2014";}', 0, 1, 1, 'content', 1, 1, 0, 1408982159),
(55, 'a:2:{s:2:"es";s:21:"Otras configuraciones";s:2:"en";s:20:"Other configurations";}', 'others_conf', '1.2', NULL, 'a:2:{s:2:"es";s:58:"Otras configuraciones como el logo. @Luis Fernando Salazar";s:2:"en";s:52:"Other configuration like logo @Luis Fernando Salazar";}', 0, 1, 1, 'content', 1, 1, 0, 1408982159),
(56, 'a:2:{s:2:"es";s:17:"Datos de Contacto";s:2:"en";s:13:"Contacts Data";}', 'contact_us', '1.0', NULL, 'a:2:{s:2:"es";s:89:"Modulo información de contacto © Brayan Acebo, Luis Fernando Salazar, Christian España";s:2:"en";s:75:"Manage Info Data © Christian España , Brayan Acebo, Luis fernando Salazar";}', 0, 1, 1, 'content', 1, 1, 0, 1408982159),
(59, 'a:2:{s:2:"es";s:20:"Trabaja con nosotros";s:2:"en";s:12:"Work with us";}', 'work_with_us', '1.0', NULL, 'a:2:{s:2:"es";s:71:"Modulo de envio de hojas de vida © Brayan Acebo, Luis Fernando Salazar";s:2:"en";s:52:"Work with us ©  Brayan Acebo, Luis fernando Salazar";}', 0, 1, 1, 'content', 1, 1, 0, 1408982159),
...
(63, 'a:2:{s:2:"en";s:4:"Chat";s:2:"es";s:4:"Chat";}', 'chat', '1.0', NULL, 'a:2:{s:2:"en";s:30:"This is a PyroCMS module Chat.";s:2:"es";s:38:"Este es un módulo de Chat en PyroCMS.";}', 0, 1, 1, 'content', 1, 1, 0, 1409246070);
...
INSERT INTO `default_products` (`id`, `name`, `slug`, `introduction`, `description`, `image`, `price`, `position`, `outstanding`, `created_at`, `updated_at`) VALUES
(6, 'lorem ipsum', 'lorem-ipsum', 'Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creación de las hojas "Letraset", las cuales contenian pasajes de Lo', 'Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creación de las hojas "Letraset", las cuales contenian pasajes de Lorem Ipsum, y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.', 'uploads/default/products/56f8aed49d66afa942c2de5b6ab62f22.jpg', 2500000, NULL, 1, '2014-03-18 18:21:18', '2014-08-27 19:17:34'),
(8, 'Ahorranito', 'ahorranito', 'Intro', 'Descripci&oacute;n', 'uploads/default/products/312b5014e305f66802627a33a8e11f0e.png', NULL, NULL, 1, '2014-07-13 23:51:36', '2014-08-25 15:46:05'),
(9, 'Alcancia', 'alcancia', 'Intro', 'Descripci&oacute;n', 'uploads/default/products/53cd8a9404b0d4ac3b7c117257ea3a61.png', NULL, NULL, 1, '2014-07-13 23:52:44', '2014-08-27 19:16:20');
...
INSERT INTO `default_products_intro` (`id`, `text`) VALUES
(1, 'Lorem Ipsum&nbsp;es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno est&aacute;ndar de las industrias desde el a&ntilde;o 1500 2');
...
INSERT INTO `default_product_categories` (`id`, `title`, `position`, `parent`, `slug`, `created_at`, `updated_at`) VALUES
(1, 'Apple', 3, 0, 'apple', '2014-03-18 17:20:12', '2014-05-08 12:51:02'),
(2, 'Auriculares', NULL, 1, 'auriculares', '2014-03-18 17:20:20', '2014-03-18 23:55:29'),
(3, 'Toshiba', 1, 0, 'toshiba', '2014-03-20 15:05:28', '2014-05-08 12:51:11'),
(4, 'Grandes', 1, 2, 'grandes', '2014-03-20 15:21:37', '2014-05-08 13:12:47'),
(5, 'Au. Medianos', 2, 2, 'au-medianos', '2014-03-21 13:31:19', '2014-08-25 21:46:00'),
(6, 'Au. Pequeños', 3, 2, 'au-pequenos', '2014-03-21 13:31:28', '2014-08-25 21:46:00'),
(7, 'LG', 2, 0, 'lg', '2014-03-21 13:31:37', '2014-05-08 12:51:11'),
(8, 'Televisores', NULL, 7, 'televisores', '2014-03-21 13:31:49', '2014-03-21 18:31:49');
...
(2, 7, 'uploads/default/products/f2610c40a3bb0c9c18cbd17229b58831.png', '2014-03-22 00:11:10'),
(3, 7, 'uploads/default/products/f7ad9d7ce1fe8c38cf77ab163291cb75.jpg', '2014-03-22 00:12:05'),
(4, 7, 'uploads/default/products/5d73a4065cf95356ba25e5c781c461fd.png', '2014-07-17 18:58:16'),
(5, 7, 'uploads/default/products/6406b5c359fa7cb6553bedf7ad5cdff0.jpg', '2014-07-17 18:58:37'),
(7, 7, 'uploads/default/products/0f760a23edce2d0d7f171defc61d151b.jpg', '2014-07-17 18:58:53'),
(11, 9, 'uploads/default/products/bb37eeee39e59960f26c47d2f1cbe565.png', '2014-08-26 16:31:47'),
(12, 7, 'uploads/default/products/753605894e20d4cca8231ce4bae040b1.png', '2014-08-27 17:17:31');
...
(6, 'Lorem Ipsum', 'Lorem Ipsum&nbsp;es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno est&aacute;ndar de las industrias desde el a&ntilde;o 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido us&oacute; una galer&iacute;a de textos y los mezcl&oacute; de tal manera que logr&oacute; hacer un libro de textos especimen. No s&oacute;lo sobrevivi&oacute; 500 a&ntilde;os, sino que tambien ingres&oacute; como texto de relleno en documentos electr&oacute;nicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creaci&oacute;n de las hojas &quot;Letraset&quot;, las cuales contenian pasajes de Lorem Ipsum, y m&aacute;s recientemente con software de autoedici&oacute;n, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.', NULL, NULL, 'blog', 'blog:post', 'blog:posts', '1', 'blog/2014/03/lorem-ipsum', 'admin/blog/edit/1', 'admin/blog/delete/1');
...
INSERT INTO `default_services` (`id`, `name`, `slug`, `introduction`, `description`, `image`, `price`, `position`, `outstanding`, `created_at`, `updated_at`) VALUES
(1, 'Producto interno', 'producto-interno', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', '<span style="color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans; font-size: 11px; line-height: 14px; text-align: justify;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</span>', 'uploads/default/services/9d801305503dcaa330b57f9254a12548.jpg', NULL, NULL, NULL, '2014-07-17 16:28:56', '2014-07-17 21:28:56');
...
INSERT INTO `default_services_intro` (`id`, `text`) VALUES
(1, '');
...
INSERT INTO `default_service_categories` (`id`, `title`, `position`, `parent`, `slug`, `created_at`, `updated_at`) VALUES
(1, 'Producción', NULL, 0, 'produccion', '2014-07-17 16:28:02', '2014-07-17 21:28:02');
...
('default_theme', 'Default Theme', 'Select the theme you want users to see by default.', '', 'default', 'bootstrapThree', 'func:get_themes', 1, 0, '', 0),
